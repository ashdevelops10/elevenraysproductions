...
import { RIAR_SAAB_PHOTOS, RIAR_SAAB_INTRO } from "@/lib/content";

const MARQUEE_PIXELS_PER_SECOND = 88;

export default function RiarSaab() {
  ...
  const loop = [...RIAR_SAAB_PHOTOS, ...RIAR_SAAB_PHOTOS];
